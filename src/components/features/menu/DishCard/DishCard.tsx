    ...
    return (
        <div className={`card d-flex flex-column gap-1 p-0  ${styles.dish}`}>
            ...
            <div className="card-body p-4 d-flex flex-column">
                ...
                <button type="button" className={`btn btn-primary d-flex justify-content-center align-items-center w-100 p-3 gap-2 rounded-pill text-black fw-bold mt-auto ${styles.orderBtn}`}>
