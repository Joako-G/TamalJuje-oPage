    ...
    return (
        <div className={`card d-flex flex-column gap-1 ${styles.dish}`}>
            ...
            <div className="card-body p-4">
                ...
                <p className={`card-text ${styles.text}`}> {description} </p>
                <button type="button" className={`btn btn-primary d-flex justify-content-center align-items-center w-100 p-3 gap-2 rounded-pill text-black fw-bold ${styles.orderBtn}`}>
